...
import (
	...
	"github.com/lujingwei002/gen_server/bin/gen-server/cmd"
	"github.com/lujingwei002/gen_server/gen/gen_application"
	"github.com/lujingwei002/gen_server/gen/gen_behavior"
	"github.com/lujingwei002/gen_server/gen/gen_const"
	"github.com/lujingwei002/gen_server/gen/gen_macro"
	"github.com/lujingwei002/gen_server/gen/gen_model"
	"github.com/lujingwei002/gen_server/gen/gen_protocol"
	"github.com/lujingwei002/gen_server/gen/gen_resource"
)
...
func genResourceAction(args *cli.Context) error {
	if err := gen_resource.Gen(gen_server.GenResourceConfig{
		Force: true,
	}); err != nil {
		return err
	}
...
func genProtocolAction(args *cli.Context) error {
	if err := gen_protocol.Gen(gen_server.GenProtocolConfig{}); err != nil {
		return err
	}
	return nil
}
...
func genModelAction(args *cli.Context) error {
	if err := gen_model.Gen(gen_server.GenModelConfig{}); err != nil {
		return err
	}
	return nil
}
...
func genApplicationAction(args *cli.Context) error {
	if err := gen_application.Gen(gen_server.GenApplicationConfig{}); err != nil {
		return err
	}
	return nil
}
...
func genConstAction(args *cli.Context) error {
	if err := gen_const.Gen(gen_server.GenConstConfig{}); err != nil {
		return err
	}
	return nil
}
...
func genBehaviorAction(args *cli.Context) error {
	if err := gen_behavior.Gen(gen_server.GenBehaviorConfig{}); err != nil {
		return err
	}
	return nil
}
...
func macroAction(args *cli.Context) error {
	...
	if err := gen_macro.Gen(gen_server.MacroConfig{}); err != nil {
		return err
	}
	return nil
}
